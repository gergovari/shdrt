...
void test_add() {
	...
	const shdrt_ServiceConnectionMap_value* res = shdrt_ServiceConnectionMap_get(&map, s);
...
void test_add_multiple() {
	...
	const shdrt_ServiceConnectionMap_value* res = shdrt_ServiceConnectionMap_get(&map, s);
	const shdrt_ServiceConnectionMap_value* res2 = shdrt_ServiceConnectionMap_get(&map, s2);
