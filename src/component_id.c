...
void
shdrt_ComponentIdentifier_drop(shdrt_ComponentIdentifier* id) {
    cstr_drop(&id->package);
    cstr_drop(&id->name);
}

int
shdrt_ComponentIdentifier_cmp(const shdrt_ComponentIdentifier* a, const shdrt_ComponentIdentifier* b) {
    int c;
...
int
shdrt_ComponentIdentifier_equals(const shdrt_ComponentIdentifier* a, const shdrt_ComponentIdentifier* b) {
